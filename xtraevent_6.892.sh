...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing  xtraevent_6.892      #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1311/refs/heads/main/enigma2-plugin-extensions-xtraevent_6.892_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xtraevent_6.892_all.ipk"

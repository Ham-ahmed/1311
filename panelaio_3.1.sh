...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing  panelaio_3.1        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1311/refs/heads/main/enigma2-plugin-extensions-panelaio_3.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-panelaio_3.1_all.ipk"
